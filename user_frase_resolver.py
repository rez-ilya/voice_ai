...
if __name__ == "__main__":
    # Тест 1: Должен сработать полностью в оффлайне (из файла open_files_os)
    print(resolve_intent("открой блокнот")) 
    
    print("-" * 30)
    
    # Тест 2: Должен уйти в ИИ, так как локальный run_app вернет None на "котиков"
    print(resolve_intent("включи видео про котиков"))